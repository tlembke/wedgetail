...
function select_date_change(select_element,date){
	year=date.substring(0,4);
	month=date.substring(5,7);
	day=date.substring(8,10);
	first_year=document.getElementById(select_element+"_year").options[0].value;
	document.getElementById(select_element+"_year").selectedIndex=year-first_year;
	document.getElementById(select_element+"_month").selectedIndex=month-1;
	document.getElementById(select_element+"_day").selectedIndex=day-1;
}